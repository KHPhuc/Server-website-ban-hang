...
exports.makeMomo = void 0;
const config_1 = require("../../config/config");
const makeMomo = (soTien, maDonHang) => {
    ...
    var redirectUrl = `${config_1.config.front}/pay-handle`;
    var ipnUrl = `${config_1.config.back}/order/receive_result`;
